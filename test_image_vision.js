...
async function testImageProcessing() {
  ...
  try {
    ...
    if (mediaResult.multimodalContent && mediaResult.multimodalContent.length > 0) {
      ...
      if (imageContent.inlineData && imageContent.inlineData.data) {
        ...
        const response = await providerManager.generateContent(multimodalPrompt);
